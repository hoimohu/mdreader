...
* (v3.0.0の変更点) リストに階層をつけるときの半角スペースは4つから2つになりました。4つのままでも問題はありません。
* 適当なので変換できないかもしれません。
...
|2026/03/26|v3.0.0|変換部分を作り直し、脚注に対応。エスケープ実装を変更。|
|2026/05/12|v3.0.1|:::noteや$$で閉じ記号を2度読み込んでいた問題と、:::noteで種類を表すクラスに謎のeが入っていた問題を修正。treeToHtmlにおいて:::noteで種類が指定されなかったときの挙動を変更。|
